...
<div class="sidenav">
    ...
    <ul class="nav_list">
        ...
        <li>
            <a class="<?= $active == 'theatres'? 'active' : '' ?>" href="<?= HOST ?>theatres">
                <i class="fas fa-theater-masks"></i>
                <span class="link">Théatres</span>
            </a>
        </li>
        <li>
            <a class="<?= $active == 'concerts'? 'active' : '' ?>" href="<?= HOST ?>concerts">
                <i class="fas fa-guitar"></i>
                <span class="link">Concerts</span>
            </a>
        </li>
        <li>
            <a class="<?= $active == 'humours'? 'active' : '' ?>" href="<?= HOST ?>humours">
                <i class="fas fa-laugh-beam"></i>
                <span class="link">Humours</span>
            </a>
        </li>
        <li>
            <a class="<?= $active == 'expositions'? 'active' : '' ?>" href="<?= HOST ?>expositions">
        ...
        <?php if (isset($_SESSION['user']) && !empty($_SESSION['user'])) { ?>
            <li>
                <a class="<?= $active == 'reservations'? 'active' : '' ?>" href="<?= HOST ?>reservations">
