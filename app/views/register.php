...
<section class="container grid">
    ...
    <div class="login-card">
        <div class="card-header">
            ...
            <span class="register_link">Déjà un compte ? <a href="<?= HOST ?>login">Se connecter</a></span>
        </div>
        ...
        <form action="<?= HOST ?>register" method="post">
            ...
            <div class="row_field">
                ...
                <div class="txt_field">
                    <i class="fas fa-key"></i>
                    <input type="password" name="confirm_password" id="" placeholder="Confirmer Mot de passe" required>
                </div>
            </div>
